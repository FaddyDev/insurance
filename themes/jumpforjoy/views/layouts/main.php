...
<div id="wrapper"><!-- #wrapper -->
		...
		<div class="menu">
				<?php $this->widget('zii.widgets.CMenu',array(
					'items'=>array(
						...
						array('label'=>'Profile', 'url'=>array('default/index'), 'visible'=>!Yii::app()->getModule('investigator')->investigatorUser->isGuest),
						//array('label'=>'About', 'url'=>array('site/page', 'view'=>'about')),
						array('label'=>'Claims', 'url'=>array('claims/admin'), 'visible'=>!Yii::app()->getModule('investigator')->investigatorUser->isGuest),
						array('label'=>'Login', 'url'=>array('default/login'), 'visible'=>Yii::app()->getModule('investigator')->investigatorUser->isGuest),
						array('label'=>'Logout ('.Yii::app()->getModule('investigator')->investigatorUser->id.')', 'url'=>array('default/logout'), 'visible'=>!Yii::app()->getModule('investigator')->investigatorUser->isGuest)
					),
				)); ?>
		</div>
	</nav><!-- end of top nav -->
	...
	<section id="main"><!-- #main content and sidebar area -->
		<section xid="container"><!-- #container -->
	...
	<footer>
		<section id="footer-area">
			<p style="text-align: center;"><?php echo '&copy '.date('Y');?> </p>
