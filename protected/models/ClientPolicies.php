...
class ClientPolicies extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cp_policy_amount', 'numerical'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('pk_cp_id, fk_cp_client_id, fk_cp_policy_id, cp_policy_period, cp_policy_expiry_date, cp_policy_count, cp_status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('cp_policy_period',$this->cp_policy_period, true);
		$criteria->compare('cp_policy_amount',$this->cp_policy_period, true);
		$criteria->compare('cp_policy_expiry_date',$this->cp_policy_expiry_date,true);
		$criteria->compare('cp_status',$this->cp_status,true);
	...
	//select active policies to post claims
	public function searchActive()
	{
		...
		$criteria->compare('cp_policy_amount',$this->cp_policy_period, true);
		$criteria->compare('cp_policy_expiry_date',$this->cp_policy_expiry_date,true);	
		$criteria->compare('cp_status','Active');	
		$criteria->compare('cp_policy_count',$this->cp_policy_count);
