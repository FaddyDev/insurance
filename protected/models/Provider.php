...
class Provider extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('provider_full_name, provider_logo, provider_password', 'length', 'max'=>100),
			array('provider_email', 'length', 'max'=>50),
			array('provider_username', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('pk_provider_id, provider_full_name, provider_email, provider_logo, provider_username, provider_password', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'policies' => array(self::HAS_MANY, 'Policy', 'fk_policy_provider_id'),
		);
	}
