...
class Policy extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('pk_policy_id, fk_policy_provider_id, policy_cover_type, policy_price, policy_period, policy_description, provider_full_name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'pk_policy_id' => 'ID',
			'fk_policy_provider_id' => 'Provider',
			'provider_full_name' => 'Provider',
			'policy_cover_type' => 'Cover Type',
			'policy_price' => 'Price',
	...
	public function search()
	{
		...
		$criteria->with=array('fkPolicyProvider');
