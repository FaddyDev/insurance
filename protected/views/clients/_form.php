...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'client_dob',array('size'=>20,'maxlength'=>20, 'placeholder'=>'dd/mm/yyyy')); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'client_bank_details',array('size'=>60,'maxlength'=>100, 'placeholder'=>'Bank Name; Branch; A/c No.')); ?>
	...
	<div class="row">
		...
		<?php echo $form->passwordField($model,'client_password',array('size'=>60,'maxlength'=>100)); ?>
