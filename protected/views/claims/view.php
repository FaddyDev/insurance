...
$this->menu=array(
	...
	array('label'=>'Post Another Claim', 'url'=>array('selectPolicy')),
	array('label'=>'Update Claim', 'url'=>array('update', 'id'=>$model->pk_claim_id)),
	array('label'=>'Delete Claim', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->pk_claim_id),'confirm'=>'Are you sure you want to delete this item?')),
