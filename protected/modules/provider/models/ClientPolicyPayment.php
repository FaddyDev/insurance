...
class ClientPolicyPayment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('pk_policy_payment_id, fk_policy_payment_cp_id, policy_payment_amount, policy_payment_receipt_no, policy_payment_status, policy_payment_datetime', 'safe', 'on'=>'search'),
		);
	}
