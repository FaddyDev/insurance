 ...
 * @property string $cp_action_reason
 *
...
class ClientPolicies extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('fk_cp_client_id, fk_cp_policy_id, cp_policy_period, cp_policy_expiry_date, cp_policy_count, cp_paid, cp_approval, cp_status, cp_action_reason', 'required'),
			array('fk_cp_client_id, fk_cp_policy_id, cp_policy_period, cp_policy_count', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('pk_cp_id, fk_cp_client_id, fk_cp_policy_id, cp_policy_period, cp_policy_expiry_date, cp_policy_count, client_fname, client_lname, cp_action_reason', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'pk_cp_id' => 'ID',
			'fk_cp_client_id' => 'Client',
			'fk_cp_policy_id' => 'Policy',
			'cp_policy_period' => 'Period',
			'cp_policy_expiry_date' => 'Expiry Date',
			'cp_policy_count' => 'Policy Count',
			'client_fname' => 'First Name',
			'client_lname' => 'Last Name',
			'cp_status' => 'Status',
			'cp_action_reason' => 'Reason',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('cp_action_reason',$this->cp_action_reason,true);
		$criteria->compare('cp_policy_count',$this->cp_policy_count, true);
		$criteria->with=array('fkCpClient','fkCpPolicy');
