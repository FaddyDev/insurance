...
class ClientCarPolicy extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('pk_car_id, fk_cp_id, car_number_plate, car_model, car_carrying_capacity, car_year_of_manufacture, car_use, car_make', 'required'),
	...
	public function relations()
	{
		...
		return array(
			'fkCp' => array(self::BELONGS_TO, 'ClientCarPolicy', 'fk_cp_id'),
			'clientCarPolicies' => array(self::HAS_MANY, 'ClientCarPolicy', 'fk_cp_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'car_model' => 'Car Model',
			'car_carrying_capacity' => 'Car Carrying Capacity',
