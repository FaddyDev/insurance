 ...
 * @property ClientPolicies $fkClaimClientPolicy
 */
class Claims extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('fk_policy_provider_id',Yii::app()->getModule("investigator")->investigatorUser->investigator_provider_id);
		$criteria->compare('claim_info',$this->claim_info,true);
		...
		$criteria->with = array('fkClaimClientPolicy.fkCpPolicy');
